...
const Resume = () => {
  ...
  const fetchResumeData = async () => {
    try {
      const [educationResult, certificationsResult, achievementsResult] =
        await Promise.all([
      ...
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Comprehensive overview of my education, certifications, and
            achievements.
          </p>
...
//             <Card
//               key={index}
//               className="p-6 card-hover bg-gradient-card border-primary/10"
//             >
